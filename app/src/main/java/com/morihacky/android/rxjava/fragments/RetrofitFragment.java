                        ...
                        .subscribeWith(
                                new DisposableObserver<List<Contributor>>() {
                                    ...
                                    public void onError(Throwable e) {
                                        Timber.e(e, "woops we got an error while getting the list of " +
                                                "contributors");
                                    }
                                    ...
                                    public void onNext(List<Contributor> contributors) {
                                        for (Contributor c : contributors) {
                                            _adapter.add(
                                                    format(
                                                            "%s 总共做出了 %d contributions 给 %s 开源库",
                                                            c.login, c.contributions, _repo.getText()
                                                                    .toString()));
                                ...
                                contributor -> {
                                    Observable<User> _userObservable =
                                            _githubService
                                                    ...
                                                    .filter(user -> !isEmpty(user.name) && !isEmpty(user
                                                            .email));
                        ...
                        .subscribeWith(
                                new DisposableObserver<Pair<User, Contributor>>() {
                                    ...
                                    public void onError(Throwable e) {
                                        Timber.e(
                                                e,
                                                "error while getting the list of contributors along with " +
                                                        "full names");
                                    }
                                    ...
                                    public void onNext(Pair<User, Contributor> pair) {
                                        ...
                                        _adapter.add(
                                                format(
                                                        "%s(%s) 总共做出了 %d contributions 给 %s 开源库",
                                                        user.name,
                                                        user.email,
